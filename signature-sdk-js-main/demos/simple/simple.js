...
Module.onRuntimeInitialized = _ => {		
   // document.getElementById("version_txt").innerHTML = Module.VERSION;
	...
	const promise = mSigObj.setLicence("7772bb50-c34f-4c3f-9944-4e23a77de201", "Jpw8tn0nB6KzjPyIVSRbRfegrzKC0XxZ44k7fM9aOc20YwWiuddeF5TgUf2Nt329EjIRnF+/CqO9fjsfo4+6Yw==");
	promise.then(value => {
	    if (value) {
	        if (navigator.hid) {				
